...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  return (
    ...
    >
      <button 
        id="close-menu-btn" 
        className="absolute top-6 right-8 text-white text-3xl hover:text-yellow-400 transition"
        onClick={onClose}
      >
      ...
      <div className="flex flex-col gap-6 text-center text-white text-2xl font-bold">
        ...
        <a href="#" className="hover:text-yellow-400 transition">Admissions</a>
        ...
        <a href="#" className="hover:text-yellow-400 transition">Research</a>
        <a href="#" className="hover:text-yellow-400 transition">Placements</a>
