...
export default function IntroOverlay() {
  useEffect(() => {
    ...
    introTL.to("#intro-logo", { opacity: 1, scale: 1.1, duration: 1 })
           .to(".anim-line", { y: 0, duration: 1.2, stagger: 0.2, ease: "power4.out" }, "-=0.5")
           .to("#intro-line", { width: "100px", duration: 0.8 }, "-=0.8")
           .to("#intro-subtitle", { opacity: 1, duration: 1 }, "-=0.6")
           .to("#intro-overlay", { opacity: 0, duration: 1, pointerEvents: "none", delay: 1 })
           .to("#hero-title, #hero-subtitle, #hero-buttons", { y: 0, opacity: 1, stagger: 0.2 })
  }, [])

  return (
    <div id="intro-overlay" className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat" 
         style={{ 
      ...
      <div className="h-[3px] w-0 bg-yellow-600 my-5 rounded-full" id="intro-line"></div>
      <h2 className="text-xs md:text-sm font-bold text-[#b45309] tracking-[0.4em] uppercase opacity-0 text-center" id="intro-subtitle">
