    ...
    <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="space-y-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F4C430]/20 border border-[#F4C430]/30 backdrop-blur-md">
          ...
          <span className="text-[#F4C430] text-xs font-black uppercase tracking-[0.2em]">Success Story 2026</span>
        </div>
        ...
        <p className="text-gray-300 text-lg md:text-xl max-w-md font-light leading-relaxed">
          Empowering our students to secure positions in the world's most prestigious organizations.
        </p>
      </div>
      ...
      <div className="relative group">
        ...
        <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 p-10 rounded-[2.5rem] shadow-2xl">
          <p className="text-[#F4C430] font-bold text-sm uppercase tracking-widest mb-2">Highest Package Achiever</p>
...
<section className="relative py-24 px-6 md:px-20 bg-[#F8F9FB] overflow-hidden">
  ...
  <div className="absolute top-0 left-0 w-full h-full opacity-[0.03] pointer-events-none">
    <svg width="100%" height="100%"><pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="#1E2A78" strokeWidth="1"/></pattern><rect width="100%" height="100%" fill="url(#grid)" /></svg>
  </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="relative group bg-white p-8 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white hover:shadow-2xl transition-all duration-500 overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-[#1E2A78] text-5xl font-black tracking-tighter mb-2 italic">320<span className="text-[#F4C430] font-bold">+</span></p>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">Students Placed</p>
      ...
      <div className="relative group bg-[#1E2A78] p-8 rounded-[2.5rem] shadow-xl transform lg:translate-y-8 transition-all duration-500">
        ...
        <div className="absolute bottom-0 right-0 p-4 opacity-10">
          <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
        </div>
      </div>
      ...
      <div className="relative group bg-white p-8 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white hover:shadow-2xl transition-all duration-500">
        <div className="relative z-10">
          ...
          <div className="mt-6 flex gap-1">
            {[1, 2, 3, 4, 5].map(i => <div key={i} className="w-2 h-2 rounded-full bg-[#F4C430]"></div>)}
          </div>
        </div>
      </div>
      ...
      return (
        <button
          ...
          className={`relative px-6 py-2.5 rounded-full text-xs md:text-sm font-bold tracking-wide uppercase transition-all duration-500 overflow-hidden ${
            isActive ? "text-[#1E2A78]" : "text-gray-500 hover:text-gray-800"
          }`}
        >
  ...
  <div className="relative flex flex-col lg:flex-row items-center gap-16 mb-40">
    ...
    <div className="w-full lg:w-1/2">
      ...
      <h2 className="text-5xl font-black text-[#1E2A78] mb-8 leading-tight">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E2A78] to-blue-500">with Industry.</span>
      </h2>
      <div className="space-y-6">
        <p className="text-gray-600 text-xl leading-relaxed font-light">
          The Placement Department has consistently achieved remarkable results, attracting reputed companies across multiple sectors every year.
        </p>
        <p className="text-gray-700 text-lg leading-relaxed border-l-4 border-[#F4C430] pl-6 italic">
          Regular aptitude, technical, and communication training sessions ensure that our students aren't just graduates, but industry-ready professionals.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div className="group bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-50">
      <div className="w-14 h-14 bg-[#F4C430]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
        <svg className="w-8 h-8 text-[#F4C430]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
      </div>
      <h3 className="text-2xl font-bold text-[#1E2A78] mb-4">Our Vision</h3>
      <p className="text-gray-600 leading-relaxed">
        To ensure every student leaves with a dream offer, fully prepared to lead in a competitive global career environment.
      </p>
    </div>
    ...
    <div className="group bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-50">
      <div className="w-14 h-14 bg-[#1E2A78]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
        <svg className="w-8 h-8 text-[#1E2A78]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
      </div>
      <h3 className="text-2xl font-bold text-[#1E2A78] mb-4">Our Mission</h3>
      <ul className="space-y-3">
        {["Adequate internships", "Skilled professionals", "Corporate partnerships"].map((text, i) => (
    ...
    <div className="lg:col-span-1 bg-[#13294B] rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
      ...
      <div className="space-y-6 relative z-10">
        <div>
          <p className="text-[#F4C430] font-bold text-lg">Prof. Rashmi Bhandary</p>
          <p className="text-gray-400 text-sm">Dean – Training & Placement</p>
        </div>
        ...
        <div className="space-y-2 pt-4 border-t border-white/10 text-sm md:text-base">
          ...
          <p className="flex items-center gap-4 hover:text-[#F4C430] transition-colors cursor-pointer">
            <span className="opacity-60">Email:</span> placements@college.edu
          </p>
        </div>
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="relative mb-24 overflow-hidden rounded-3xl bg-white shadow-xl flex flex-col md:flex-row items-center">
      ...
      <div className="p-12 md:p-16 flex-1">
        ...
        <h3 className="text-5xl font-extrabold text-[#1E2A78] mb-6 tracking-tight">
          Dr. Rajesh Kumar
        </h3>
        <p className="text-gray-600 text-xl leading-relaxed font-light italic border-l-2 border-gray-200 pl-6">
          "Dr. Rajesh Kumar leads the Training and Placement Cell with over
          15 years of academic and corporate experience. Under his leadership,
          the institution has strengthened industry collaborations and achieved
          consistent placement excellence."
        </p>
      </div>

      {/* RIGHT IMAGE WITH STYLED BACKGROUND */}
      <div className="relative w-full md:w-[450px] h-[550px] bg-[#1E2A78]">
        <img
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {[
        { name: "Ms. Anjali Mehta", img: "https://randomuser.me/api/portraits/women/65.jpg" },
        { name: "Mr. Vivek Sharma", img: "https://randomuser.me/api/portraits/men/32.jpg" },
        { name: "Ms. Kavya Nair", img: "https://randomuser.me/api/portraits/women/44.jpg" },
        { name: "Mr. Arjun Patel", img: "https://randomuser.me/api/portraits/men/51.jpg" },
        { name: "Ms. Sneha Rao", img: "https://randomuser.me/api/portraits/women/12.jpg" },
        { name: "Mr. Rahul Verma", img: "https://randomuser.me/api/portraits/men/19.jpg" },
        { name: "Ms. Priya Iyer", img: "https://randomuser.me/api/portraits/women/33.jpg" },
        { name: "Mr. Karan Singh", img: "https://randomuser.me/api/portraits/men/40.jpg" },
      ].map((member, index) => (
        <div
          key={index}
  ...
  <div className="relative">
    ...
    <InfiniteSlider speed={0.8}>
      {[
        ...
        { name: "Ms. Kavya Nair", dept: "CSE", company: "Infosys", ctc: "18.20 Lakhs", img: "https://randomuser.me/api/portraits/women/26.jpg" },
        { name: "Mr. Rahul Verma", dept: "ECE", company: "IBM", ctc: "12.50 Lakhs", img: "https://randomuser.me/api/portraits/men/27.jpg" },
        { name: "Ms. Priya Iyer", dept: "CSE", company: "Capgemini", ctc: "10.80 Lakhs", img: "https://randomuser.me/api/portraits/women/28.jpg" },
      ]
        ...
        >
          ...
          <div className="ml-6 flex-grow">
            ...
            <div className="mt-2 text-[#1E2A78] font-bold text-sm">
              <span className="text-[10px] text-gray-400 font-medium uppercase mr-2">CTC:</span>
              {student.ctc}
            </div>
          </div>
        </div>
...
>
  <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
    <div>
      ...
      <p className="text-gray-500 mt-2">Capturing moments of success and professional growth.</p>
    </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[200px]">
    {[
      { title: "Cognizant Drive", img: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d", size: "lg:col-span-2 lg:row-span-2" }, // Large Square
      { title: "iWave Recruitment", img: "https://images.unsplash.com/photo-1552664730-d307ca884978", size: "lg:col-span-1 lg:row-span-1" }, // Small Square
      { title: "IMV Corporation", img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f", size: "lg:col-span-1 lg:row-span-2" }, // Tall
      { title: "Accenture Visit", img: "https://images.unsplash.com/photo-1531482615713-2afd69097998", size: "lg:col-span-1 lg:row-span-1" }, // Small Square
      { title: "Amazon Hiring", img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c", size: "lg:col-span-2 lg:row-span-1" }, // Wide
      { title: "Infosys Drive", img: "https://images.unsplash.com/photo-1556761175-4b46a572b786", size: "lg:col-span-1 lg:row-span-2" }, // Tall
      { title: "IBM Interview", img: "https://images.unsplash.com/photo-1551836022-d5d88e9218df", size: "lg:col-span-1 lg:row-span-1" }, // Small
      { title: "Capgemini Event", img: "https://images.unsplash.com/photo-1492724441997-5dc865305da7", size: "lg:col-span-1 lg:row-span-1" }, // Small
    ].map((item, index) => (
      <div
        key={index}
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#1E2A78]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8">
          <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            <span className="text-[#F4C430] text-[10px] font-bold uppercase tracking-widest">Placement 2024</span>
